...
struct SenderCallUnsubscribeTestInput {
...
std::ostream& operator<<(std::ostream& os, SenderCallUnsubscribeTestInput test_input) {
  return os << test_input.description;
}

class SenderCallUnsubscribeTests : public SenderTestSuite,
                                   public ::testing::WithParamInterface<SenderCallUnsubscribeTestInput> {};

TEST_P(SenderCallUnsubscribeTests, SenderCallUnsubscribeTests) {
  ...
  // Act: Run the CallUnsubscribe()
  const EebusError ret = SEND_CALL_UNSUBSCRIBE(sender, sender_addr.get(), dest_addr.get());
...
INSTANTIATE_TEST_SUITE_P(
    SenderCallUnsubscribeTests,
    SenderCallUnsubscribeTests,
    ::testing::Values(
        SenderCallUnsubscribeTestInput{
            .description = "Test Node Management Subscription Delete call"sv,
        ...
        SenderCallUnsubscribeTestInput{
            .description = "Test Node Management Subscription Delete call (another attempt)"sv,
            .sender_addr = FEATURE_ADDRESS_TEST_DATA("d:_i:Demo_EVSE-234567890", {0}, 0),
            .dest_addr   = FEATURE_ADDRESS_TEST_DATA("d:_i:36013_3019197057", {0}, 0),
            .msg_cnt     = 1,
            .msg         = R"({"datagram":[
