...
/**
 * @file
 * @brief EEEBUS Data Tag
 */

#ifndef SRC_COMMON_EEBUS_DATA_EEBUS_DATA_TAG_H_
#define SRC_COMMON_EEBUS_DATA_EEBUS_DATA_TAG_H_
...
/**
 * @brief EEBUS Data Tag Interface
 */
extern const EebusDataInterface eebus_data_tag_methods;

/**
 * @brief EEBUS Data Tag type check
 */
#define EEBUS_DATA_IS_TAG(cfg) (EEBUS_DATA_INTERFACE(cfg) == &eebus_data_tag_methods)

/**
 * @brief EEBUS Data Tag configuration
...
#endif  // SRC_COMMON_EEBUS_DATA_EEBUS_DATA_TAG_H_
