...
#ifndef SRC_USE_CASE_SPECIALIZATION_LOAD_CONTROL_LOAD_LIMIT_H_
#define SRC_USE_CASE_SPECIALIZATION_LOAD_CONTROL_LOAD_LIMIT_H_
...
#endif  // SRC_USE_CASE_SPECIALIZATION_LOAD_CONTROL_LOAD_LIMIT_H_
