...
/**
 * @file
 * @brief Websocket Wsi implementation declarations
 */

#ifndef SRC_SHIP_WEBSOCKET_WEBSOCKET_SERVER_H_
#define SRC_SHIP_WEBSOCKET_WEBSOCKET_SERVER_H_
...
#endif  // SRC_SHIP_WEBSOCKET_WEBSOCKET_SERVER_H_
