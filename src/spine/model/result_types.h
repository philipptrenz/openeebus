...
/**
 * @file
 * @brief SPINE Datagram Result data types declarations
 */

#ifndef SRC_SPINE_MODEL_RESULT_TYPES_H_
#define SRC_SPINE_MODEL_RESULT_TYPES_H_
...
#endif  // SRC_SPINE_MODEL_RESULT_TYPES_H_
