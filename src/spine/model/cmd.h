...
/**
 * @file
 * @brief SPINE Datagram Command helper subroutines
 */

#ifndef SRC_EEBUS_SRC_SPINE_MODEL_CMD_H_
#define SRC_EEBUS_SRC_SPINE_MODEL_CMD_H_
...
#endif  // SRC_EEBUS_SRC_SPINE_MODEL_CMD_H_
